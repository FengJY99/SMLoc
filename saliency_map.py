...
posenet = PoseNet(feature_extractor, droprate=opt.test_dropout, pretrained=False)
...
if opt.model == 'AtLoc' or opt.model == 'CViPLocV2' or opt.model == 'CAPLoc' or opt.model == 'PoseNet':
