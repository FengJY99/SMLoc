...
class ConvAtLocV2(nn.Module):
    ...
    def __init__(self, feature_extractor, droprate=0.5, pretrained=True, feat_dim=2048, lstm=False):
        ...
        self.fc1 = nn.Linear(feat_dim, 50)
        self.fc2 = nn.Linear(feat_dim, 50)
        ...
        if self.lstm:
            ...
            self.fc_xyz = nn.Linear(50, 3)
            self.fc_wpqr = nn.Linear(50, 3)
